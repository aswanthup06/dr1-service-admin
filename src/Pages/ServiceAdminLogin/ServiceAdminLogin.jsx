...
export default function ServiceAdminLogin() {
  return (
    ...
    <img className='w-14 h-14 object-cover rounded-full' src="https://images.unsplash.com/photo-1737366984875-fb81751f6655?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
...
<div className='relative h-12 w-80 mt-3'>
    ...
    {/* <input  className='h-12 bg-slate-100 w-80 border mt-3' type="text" name="" id="" /> */}
...
<label className="flex items-center mt-4 w-80">
  ...
  <span className="ml-2 text-sm text-slate-500">Show Password</span>
    ...
    <button className='h-12 bg-indigo-600 w-80 text-white font-thin text-sm mt-6' >Login</button>
